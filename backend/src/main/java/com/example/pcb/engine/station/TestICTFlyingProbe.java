...
public class TestICTFlyingProbe extends AssemblyStation implements PCBCheckStation {

    private final FailureRateService failureRateService;

    public TestICTFlyingProbe(FailureRateService failureRateService) {
